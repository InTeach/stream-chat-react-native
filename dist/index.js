  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(Container$2, {
        ...
        resizeMode: "cover"
      }), Footer ? React__default.createElement(Footer, this.props) : React__default.createElement(CardFooter, null, React__default.createElement(reactNative.View, {
        style: {
          display: 'flex',
...
var Date$1 = styled__default.Text(_templateObject4$3(), function (_ref5) {
  var theme = _ref5.theme;
...
var EmptyStateIndicator = function EmptyStateIndicator(_ref) {
  ...
  switch (listType) {
    ...
    default:
      Indicator = React__default.createElement(reactNative.Text, null, "No items exist");
      break;
  }
    ...
    value: function render() {
      ...
      if (type === 'giphy') {
        if (a.actions && a.actions.length) {
          return React__default.createElement(reactNative.View, null, React__default.createElement(Giphy, _extends({}, a, {
            alignment: this.props.alignment
      ...
      if (type === 'card') {
        if (a.actions && a.actions.length) {
          return React__default.createElement(reactNative.View, null, React__default.createElement(Card$$1, _extends({}, a, {
            alignment: this.props.alignment
          }, cardProps)), a.actions && a.actions.length > 0 && React__default.createElement(AttachmentActions$$1, _extends({
            key: 'key-actions-' + a.id
          }, a, {
...
var IconSquare = function IconSquare(_ref3) {
  ...
  }));else return React__default.createElement(StyledView, null, React__default.createElement(reactNative.Image, {
    source: icon,
    style: {
      height: 15,
      width: 15
...
var LoadingErrorIndicator = function LoadingErrorIndicator(_ref) {
  ...
  switch (listType) {
    case 'channel':
      Loader = React__default.createElement(reactNative.Text, null, t('Error loading channel list ...'));
      break;

    case 'message':
      Loader = React__default.createElement(reactNative.Text, null, t('Error loading messages for this channel ...'));
      break;

    default:
      Loader = React__default.createElement(reactNative.Text, null, t('Error loading'));
      break;
  }
...
var Circle = styled__default(AnimatedView)(_templateObject$g(), function (_ref) {
  var theme = _ref.theme;
  return theme.colors.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$9 = styled__default.View(_templateObject$h(), function (_ref) {
  var theme = _ref.theme;
  return theme.loadingIndicator.container.css;
});
var LoadingText = styled__default.Text(_templateObject2$c(), function (_ref2) {
  var theme = _ref2.theme;
...
var Spacer = styled__default.View(_templateObject2$d(), function (_ref4) {
  var theme = _ref4.theme;
...
var TouchableWrapper = styled__default.View(_templateObject$j(), function (_ref) {
  var alignment = _ref.alignment;
...
var Container$b = styled__default.View(_templateObject2$e(), function (_ref3) {
...
var TextContainer = styled__default.View(_templateObject$k(), function (_ref) {
  var theme = _ref.theme,
...
var ContainerView = styled__default.View(_templateObject2$g(), function (_ref3) {
  var theme = _ref3.theme;
...
var ContainerInner = styled__default.View(_templateObject2$h(), function (_ref10) {
  ...
  _createClass(MessageContent, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(MessageContentContext.Provider, {
        ...
        alignment: alignment
      }, this.props.formatDate ? this.props.formatDate(message.created_at) : tDateTimeParser(message.created_at).format('LT'))) : null, React__default.createElement(reactNativeActionsheet.ActionSheetCustom, {
        ref: function ref(o) {
...
var Spacer$1 = styled__default.View(_templateObject$o());
var StatusContainer = styled__default.View(_templateObject2$i());
...
var Container$f = styled__default.View(_templateObject$p(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageList.messageSystem.container.css;
});
var Line$1 = styled__default.View(_templateObject2$j(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.light;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var MessageSystem = function MessageSystem(_ref7) {
  ...
  return React__default.createElement(Container$f, null, React__default.createElement(Line$1, null), React__default.createElement(TextContainer$1, null, React__default.createElement(Text, null, message.text.toUpperCase()), React__default.createElement(DateText$1, null, tDateTimeParser(message.created_at).calendar().toUpperCase())), React__default.createElement(Line$1, null));
};
...
var Container$h = styled__default.TouchableOpacity(_templateObject$r(), function (_ref) {
  var theme = _ref.theme;
  return theme.colors.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var MessageNotificationText = styled__default.Text(_templateObject2$k(), function (_ref3) {
  var theme = _ref3.theme;
...
var Wrapper = styled__default.TouchableOpacity(_templateObject$s(), function (_ref) {
...
var Container$i = styled__default.View(_templateObject2$l(), function (_ref3) {
  ...
  _createClass(ChannelInner, [{
    ...
    value: function render() {
      ...
      if (this.state.error) {
        ...
        core = React__default.createElement(reactNative.View, null, React__default.createElement(reactNative.Text, null, t('Channel Missing')));
      } else {
  ...
  _createClass(Channel, [{
    ...
    value: function render() {
      ...
      if (!this.props.channel.cid) {
        return React__default.createElement(reactNative.Text, null, t('Please select a channel first'));
      }
...
var TypingText = styled__default.Text(_templateObject$t(), function (_ref) {
  var theme = _ref.theme;
...
var Container$j = styled__default.View(_templateObject2$m(), function (_ref4) {
  var theme = _ref4.theme;
...
var ListContainer = styled__default.FlatList(_templateObject$u(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageList.listContainer.css;
});
var ErrorNotificationText = styled__default.Text(_templateObject2$n(), function (_ref2) {
  var theme = _ref2.theme;
...
var Container$k = styled__default.TouchableOpacity(_templateObject$v(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.sendButton.css;
});
var SendButtonIcon = styled__default.Image(_templateObject2$o(), function (_ref2) {
  var theme = _ref2.theme;
...
var AttachButtonIcon = styled__default.Image(_templateObject2$p(), function (_ref2) {
  var theme = _ref2.theme;
...
var EditingBoxContainer = styled__default.View(_templateObject2$q(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageInput.editingBoxContainer.css;
});
var EditingBoxHeader = styled__default.View(_templateObject3$h(), function (_ref5) {
  var theme = _ref5.theme;
...
var Container$n = styled__default.TouchableOpacity(_templateObject$y(), function (_ref) {
  var theme = _ref.theme;
  return theme.channelPreview.container.css;
});
var Details = styled__default.View(_templateObject2$r(), function (_ref2) {
  var theme = _ref2.theme;
...
var Date$3 = styled__default.Text(_templateObject5$b(), function (_ref5) {
  var theme = _ref5.theme;
...
var NewThread = styled__default.View(_templateObject$z(), function (_ref) {
  var theme = _ref.theme;
  return theme.thread.newThread.css;
});
var NewThreadText = styled__default.Text(_templateObject2$s(), function (_ref2) {
  var theme = _ref2.theme;
...
var Container$o = styled__default.View(_templateObject$A());
var Icon$1 = styled__default.View(_templateObject2$t(), function (_ref) {
  var theme = _ref.theme;
...
var IconBadge = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(IconBadge, [{
    ...
    value: function render() {
      ...
      return React.createElement(Container$o, null, children, unread > 0 && React.createElement(Icon$1, null, React.createElement(IconInner, null, showNumber && React.createElement(UnreadCount, null, unread))));
    }
  }]);
